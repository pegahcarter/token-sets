...
interface ICore {
    /**
     * @dev Return transferProxy address.
    ...
    /**
     * @dev Return address belonging to given exchangeId.
    ...
    /**
     * @dev Return boolean indicating if address is a valid Rebalancing Price Library.
    ...
    /**
     * @dev Exchanges components for Set Tokens
    ...
    /**
     * @dev Issues a specified Set for a specified quantity to the recipient
