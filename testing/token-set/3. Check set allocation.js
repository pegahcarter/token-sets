...
;(async () => {
  ...
  // componentUnits.forEach(x => console.log(x / baseUnit));
  ...
  // let units2 = await setProtocol.setToken.getUnitsAsync('0xffee21b4bb7084a9416205544101ae9f472c7159');
  // units2.forEach(x => console.log(x.toNumber()));
